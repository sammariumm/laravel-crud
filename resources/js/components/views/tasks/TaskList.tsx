...
const TaskList = () => {
    const { taskList, updateContext, startEdit } = useTaskContext();
                        ...
                        <ul className="menu menu-horizontal bg-base-200 rounded-box">
                            ...
                            <li>
                                <div className="tooltip" data-tip="Edit">
                                    <svg width={15} height={15} fill="none" onClick={() => startEdit(task)} className="stroke-current" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
